...
! *** Model- and data specific variables ***
  ...
  INTEGER                 :: obs_blk_size = 4  ! block size for observations in state
  INTEGER                    :: obs_share = 20   ! percentage of dim_state gives number of observations
  ...
  ! [TODO] implement local filters. these vars are not used yet. only for compilation
  REAL, ALLOCATABLE    :: distance_l(:)
  REAL, ALLOCATABLE    :: obs_f(:)
  REAL, ALLOCATABLE :: coords_obs_f(:,:)
